      ...
      <section class="home-hero">
        ...
        <div class="hero-images">
          <div class="split-image-container" id="splitContainer">
            ...
            <input type="range" min="0" max="100" value="50" id="sliderInput" style="position:absolute; top:0; left:0; width:100%; height:100%; opacity:0; cursor:col-resize; z-index:10;">
          </div>
      ...
      <section class="feed-section">
        <div class="feed-header">
          ...
          <div class="feed-controls">
            <button class="icon-btn active"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="8" y1="6" x2="21" y2="6"></line><line x1="8" y1="12" x2="21" y2="12"></line><line x1="8" y1="18" x2="21" y2="18"></line><line x1="3" y1="6" x2="3.01" y2="6"></line><line x1="3" y1="12" x2="3.01" y2="12"></line><line x1="3" y1="18" x2="3.01" y2="18"></line></svg></button>
            <button class="icon-btn"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg></button>
          </div>
        </div>
        ...
        <div class="feed-grid">
          <!-- Column 1: Trending -->
          <div class="feed-col">
            <h3 class="col-title"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"></polyline><polyline points="16 7 22 7 22 13"></polyline></svg> TRENDING NOW</h3>
            <div id="postsContainer"></div>
          </div>

          <!-- Column 2: Active Campaigns -->
          <div class="feed-col">
            <h3 class="col-title"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg> ACTIVE CAMPAIGNS</h3>
            <div id="campaignsContainer"></div>
          </div>

          <!-- Column 3: Impact & Stewards -->
          <div class="feed-col">
            <h3 class="col-title"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 12h-4l-3 9L9 3l-3 9H2"></path></svg> COMMUNITY IMPACT</h3>
            <div id="statsContainer"></div>
            <div class="card" style="margin-top: 24px;">
              <div class="card-content">
                <p class="title-small">Top Stewards this Month</p>
                <div class="steward-list" id="stewardsContainer"></div>
                <button class="btn btn-outline w-full" style="padding: 8px; font-size: 13px; margin-top: 16px;">View Leaderboard</button>
              </div>
            </div>
          </div>
        </div>
